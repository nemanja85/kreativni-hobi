<?php $__env->startSection('content'); ?>
    ...
    <div class="payments">
      <div class="container user">
           <form  id="payments" name="payments" method="POST" action="<?php echo e($urlAik); ?>">
                    ...
                    <div class="col s12 m12 l6" v-cloak>
                    	<h2>Naručilac</h2>
                    		 ...
                    		 <div class="row">
                                ...
                                <input type="hidden" name="trantype" value="<?php echo e($transactionType); ?>" />
                                <input type="hidden" name="instalment" value="<?php echo e($instalment); ?>" />
                                ...
                                <input type="hidden" name="currency" value="<?php echo e($currencyVal); ?>" />
                              ...
                              <div v-if="showCompany">
                               ...
                               <?php if(auth()->guard()->guest()): ?>
                    		    <div class="row">
                              	<div class="input-field col s12 m6 l6">
                                  	<input v-model='user.ShipToName' placeholder="*Ime i Prezime" id="first_name" name="BillToName" type="text" class="validate" value="<?php echo e(old('first_name' )); ?>">
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input placeholder="*E-mail adresa:" id="email" name="email" type="email" class="validate" value="<?php echo e(old('email')); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                  	<input placeholder="Telefon:" id="phone" name="phone" type="text" class="validate" value="<?php echo e(old('phone' )); ?>">
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input v-model='user.ShipToStreet1' placeholder="*Adresa:" id="address" name="BillToStreet1" type="text" class="validate" value="<?php echo e(old('BillToStreet1')); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                  	<input v-model='user.ShipToCity' placeholder="*Grad:" id="city" name="BillToCity" type="text" class="validate" value="<?php echo e(old('BillToCity')); ?>">
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input v-model='user.ShipToPostalCode' placeholder="*Poštanski broj:" id="postal_code" name="BillToPostalCode" type="text" class="validate" value="<?php echo e(old('BillToPostalCode')); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                    <input  v-model='user.ShipToCountry' placeholder="*Zemlja:" id="country" name="BillToCountry"  type="text" class="validate" value="<?php echo e(old('BillToCountry')); ?>">
                                </div>
                            </div>
                                <?php else: ?>
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                    <input placeholder="*Ime i Prezime:" id="first_name" name="BillToName" type="text" class="validate" value="<?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?>">
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input placeholder="*E-mail adresa:" id="email" name="email" type="email" class="validate" value="<?php echo e(Auth::user()->email); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                    <input placeholder="Telefon:" id="phone" name="phone" type="text" class="validate" value="<?php echo e(Auth::user()->phone); ?>">
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input placeholder="*Adresa:" id="address" name="BillToStreet1" type="text" class="validate" value="<?php echo e(Auth::user()->address); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                    <input placeholder="*Grad:" id="city" name="BillToCity" type="text" class="validate" value="<?php echo e(Auth::user()->city); ?>">
                                </div>
                                <div class="input-field col s12 m6 l6">
                                    <input  placeholder="*Poštanski broj:" id="postal_code" name="BillToPostalCode" type="text" class="validate" value="<?php echo e(Auth::user()->zip); ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                    <input  placeholder="*Zemlja:" id="country" name="BillToCountry" type="text" class="validate" value="<?php echo e(Auth::user()->country); ?>">
                                </div>
                            </div>
                            <?php endif; ?>
                           <?php if(auth()->guard()->guest()): ?>
    ...
    <label for="test5">Ukoliko želite da koristite istu adresu za dostavu.</label>
                        ...
                        <div v-if='!guest'>
                            ...
                            <?php if(isset($vaucer) && !empty($vaucer)): ?>
                    ...
                    <?php if(isset($allInBaskets)): ?>
                                 ...
                                 <tr v-cloak>
                                  ...
                                  <input type="hidden" name="printBillTo" value="true">
                                  <input type="hidden" name="ItemNumber_<?php echo e($item->ItemInBasket[0]->id); ?>" value="<?php echo e($item->ItemInBasket[0]->id); ?>">
                                  <input type="hidden" name="ProductCode_<?php echo e($item->ItemInBasket[0]->id); ?>" value="<?php echo e($item->ItemInBasket[0]->id); ?>">
                                  <input type="hidden" name="Qty_<?php echo e($item->ItemInBasket[0]->id); ?>" value="<?php echo e($item->amount); ?>">
                                  <input type="hidden" name="Desc_<?php echo e($item->ItemInBasket[0]->id); ?>" value="<?php echo e($item->ItemInBasket[0]->name); ?>">
                                  <input type="hidden" name="Id_<?php echo e($item->ItemInBasket[0]->id); ?>" value="<?php echo e($item->ItemInBasket[0]->id); ?>">
                                  <input type="hidden" name="Price_<?php echo e($item->ItemInBasket[0]->id); ?>" value="<?php echo e($item->ItemInBasket[0]->price); ?>">
                                  <input type="hidden" name="Total_<?php echo e($item->ItemInBasket[0]->id); ?>" value="<?php echo e($item->amount); ?>">


                                    <td><?php echo e($item->ItemInBasket[0]->name); ?></td>
                                    <td class="center-align"><i class="material-icons" @click="deleteItem(<?php echo e($item->ItemInBasket[0]->id); ?>)">delete</i></td>
                                         <td class="center-align"><?php echo e($item->amount); ?></td>
                                    <td class="right-align"><?php echo e($item->price); ?> Din</td>
                                </tr>
                            ...
                            <tfoot >
	                              <tr>
	                                  ...
	                                  <td class="subtotal  right-align"><?php echo e($amount); ?> Din</td>
	                              </tr>
	                              <tr>
	                                  <td colspan="3">PDV  20%</td>
	                                  <td class="pdv  right-align"><?php echo e($pdv); ?> Din</td>
	                              </tr>
	                              <tr class="strong">
	                                  <td colspan="3">Za uplatu</td>
	                                  <td class="total right-align"><?php echo e($amount); ?> Din</td>
	                              </tr>
                            </tfoot>
                      <?php endif; ?>
                          	...
                          	<div class="collapsible-header">
                      	      ...
                      	      <li v-if="!showCompany" id="personal">
                                  ...
                                  <?php else: ?>
                                                                    <div class="collapsible-body">
                                      <div class="slips payment-slip">
                                          <span class="user-data"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?>, <?php echo e(Auth::user()->address); ?>,  <?php echo e(Auth::user()->city); ?></span>
                                          <span class="purpose">Online kupovina</span>
                                          <span class="recepient">Kreativni hobi doo, Prve pruge 37P,<br/>11080 Zemun, Beograd</span>
                                          <span class="code">221</span>
                                          <span class="currency">RSD</span>
        ...
        <div class="row uplatnica-holder">
            ...
            <div  class="person">
                ...
                <div class="col s12 m12 l12">
                    <div class="slips payment-slip">
                        <img src="<?php echo e(asset('images/personal.jpg')); ?>"  width="620" alt="Uplatnica"/>
              ...
              <div class="company">
                  ...
                  <div class="col s12 m12 l12">
                      <div class="nalog-text" style="font-family: 'Raleway', sans-serif;position: relative;left: 0;font-size: 1.26rem;height: 320px;background-repeat: no-repeat;margin: 20px auto;text-align: left;">
                          <div class="slips transfer-order">
                              <img src="<?php echo e(asset('images/company.jpg')); ?>"  width="620" alt="Nalog za prenos"/>
