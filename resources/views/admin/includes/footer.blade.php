            ...
            <div class="row">
              ...
              <div class="col s12 m4 l4 hide-on-small-only">
                <ul>
                  ...
                  <li><a class="grey-text text-lighten-3" href="{{ route('opšti-uslovi') }}">OPŠTI USLOVI SLANJA ROBE</a></li>
              ...
              <div class="col s12 m4 l4">
                  <div class="col s8 m9 l9">
                      ...
                      <div class="cards-payment">
                          <img src="{{asset('images/cards-payment/visa.png')}}" alt="Visa" />
                          <img src="{{asset('images/cards-payment/aik.png')}}" alt="AIK" />
                      </div>
                      <div class="cards-payment">
                          <img src="{{asset('images/cards-payment/master-secure.png')}}" alt="Master Card" />
                          <img src="{{asset('images/cards-payment/paypal.png')}}" alt="Paypal" />
                      </div>
                  </div>
                  <div class="col s3 m3 l3 social-icons">
                      <ul>
                        <li><a href="javascript:void(0)"><img src="{{asset('images/social-icons/footer-facebook-logo.png')}}" alt="facebook logo" /></a></li>
                        <li><a href="javascript:void(0)"><img src="{{asset('images/social-icons/footer-instagram-logo.png')}}" alt="instagram logo" /></a></li>
                        <li><a href="javascript:void(0)"><img src="{{asset('images/social-icons/footer-twitter-logo.png')}}" alt="twitter-logo" /></i></a></li>
                      </ul>
                  </div>
