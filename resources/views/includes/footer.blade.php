            ...
            <div class="row">
              ...
              <div class="col s12 m4 l4 pages">
                <ul>
                  ...
                  <li><a href="{{ route('politika') }}">USLOVI KORIŠĆENJA/POLITIKA PRIVATNOSTI</a></li>
                  <li><a href="{{ route('opšti-uslovi') }}">OPŠTI USLOVI SLANJA ROBE</a></li>
                </ul>
              </div>
              <div class="col s12 m4 l4">
                  <div class="col s12 m9 l11 payment">
                      ...
                      <div class="cards-payment">
                          <img src="{{asset('images/cards-payment/visa.jpg')}}" alt="Visa" />
                          <img src="{{asset('images/cards-payment/aik_bank.jpg')}}" alt="AIK" />
                      </div>
                      <div class="cards-payment">
                          <img src="{{asset('images/cards-payment/master_card.jpg')}}" alt="Master Card" />
                          <img src="{{asset('images/cards-payment/paypal.jpg')}}" alt="Paypal" />
                      </div>
                  </div>
                  <div class="col s12 m3 l1 social-icons">
                      <ul>
                        <li><a href="https://sr-rs.facebook.com/kreativni.hobi.1/" target="_blank"><img src="{{asset('images/social-icons/footer-facebook-logo.png')}}" alt="facebook logo" /></a></li>
                        <li><a href="javascript:void(0)"><img src="{{asset('images/social-icons/footer-instagram-logo.png')}}" alt="instagram logo" /></a></li>
                        <li><a href="javascript:void(0)"><img src="{{asset('images/social-icons/footer-youtube-logo.png')}}" alt="twitter-logo" /></i></a></li>
                      </ul>
                  </div>
